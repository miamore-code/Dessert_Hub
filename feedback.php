...

{
 ...
 $insert="insert into feedback(username,email,mobile,message) values('$unm','$em','$mob','$msg')";
...

{
 ...
 alert('Sorry your Feedback Form is Not Submited Try again')
				...
				<div class="col-md-8 agileinfo_mail_grid_right">
					<form method="post">
						<div class="col-md-6 wthree_contact_left_grid">
							<input type="text" name="unm" value="Name*" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name*';}" required>
							<input type="text" name="mob" value="Telephone*" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Telephone*';}" required style="width: 100%">
						</div>
						<div class="col-md-6 wthree_contact_left_grid">
							<input type="email" name="em" value="Email*" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email*';}" required style="margin-top: 0px;">
							<!--<input type="text" name="sub" value="Subject*" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Subject*';}" required>-->
						</div>
